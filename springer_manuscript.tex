...
\begin{figure}[h]
    ...
    \caption{Ablation 4: Linear Probe Classification (5\% Split). HybridSN transfers robust, linearly separable features (+15\% gain), while the evaluated transformer implementations completely fail to transfer generalized representations under this annotation regime.}
