...
\begin{figure*}[t]
    \centering
    \includegraphics[width=0.32\textwidth]{Figure_Training_Curves_HybridSN_5pct.png}
    \includegraphics[width=0.32\textwidth]{Figure_Training_Curves_ViT_5pct.png}
    \includegraphics[width=0.32\textwidth]{Figure_Training_Curves_SpectralFormer_5pct.png}
