...
\par Crucially, our study suggests that Cross-Domain Transfer Learning offers an effective transfer-learning bridge to this gap, but strictly enforces a domain hierarchy. Pre-training deep architectures on diverse macro-agriculture data before deploying them on starved micro-soil environments effectively boosted ViT accuracy by +36.8\% and allowed 3D-CNNs to surpass traditional Machine Learning significantly earlier. However, reversing this hierarchy triggered model collapse due to negative transfer.
