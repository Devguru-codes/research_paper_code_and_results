...
\author[2]{\fnm{Nagamani} \sur{Molakatala}}\email{manidcis@gmail.com}
\author[3]{\fnm{R.} \sur{Kokila}}\email{kok.oc25@gmail.com}
\author[4]{\fnm{Gururaja} \sur{H S}}\email{gururajhs.ise@bmsce.ac.in}
\author[5]{\fnm{J.} \sur{Rajini}}\email{rajinimoorthydd@gmail.com}
...
\affil[2]{\orgdiv{School of Computer and Information Sciences}, \orgname{University of Hyderabad}, \orgaddress{\city{Hyderabad}, \state{Telangana}, \country{India}}}

\affil[3]{\orgdiv{School of Computer Applications}, \orgname{Dayananda Sagar University}, \orgaddress{\street{Kudlu Campus}, \city{Bengaluru}, \state{Karnataka}, \country{India}}}

\affil[4]{\orgdiv{Dept of Computer Science and Business Systems}, \orgname{B.M.S. College of Engineering}, \orgaddress{\street{Basavanagudi}, \city{Bangalore}, \state{Karnataka}, \country{India}}}

\affil[5]{\orgdiv{Department of English}, \orgname{Kongu Engineering College}, \orgaddress{\city{Erode}, \state{Tamil Nadu}, \country{India}}}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=0.8\textwidth]{Figure1_Workflow.png}
...
\begin{figure*}[htbp]
\centering
\includegraphics[width=\textwidth]{Figure_Architecture.png}
\caption{The Proposed Hybrid ConvStem-Transformer Architecture. A 3D-CNN stem extracts local spatial-spectral inductive biases from the hyperspectral data cube prior to tokenization. The sequential tokens, prefixed with a global [CLS] representation, are processed by a Pre-Layer Normalization Transformer encoder. A final Multilayer Perceptron (MLP) head projects the [CLS] token to the land cover class prediction.}
...
\begin{figure*}[h]
\centering
\includegraphics[width=\textwidth]{Figure7_TransferLearning.png}
